...
//			readBytes(2);
			...
			if (!datasubchunk.endsWith("data")) {
				...
				//用于处理ffmpeg得到的wav文件
				 ...
				 String chunk = readString(WaveConstants.LENDATASUBCHUNK);
				 if(!chunk.endsWith("data")){
					 throw new IllegalArgumentException("data miss, " + filename + " is not a wave file." + chunk);
					 }
				//-------------------
//				throw new IllegalArgumentException("data miss, " + filename + " is not a wave file." + datasubchunk);
			}
