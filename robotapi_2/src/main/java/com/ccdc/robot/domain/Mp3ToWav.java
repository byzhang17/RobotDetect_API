...
public class Mp3ToWav {
    ...
    public static void ToWave(String path)
    {
        String mp3filepath = path + "\\out.mp3";//mp3文件路径
        String pcmfilepath = path + "\\out.pcm";//转化后的pcm路径
        String wavfilepath = path + "\\out.wav";//转化后的wav路径
